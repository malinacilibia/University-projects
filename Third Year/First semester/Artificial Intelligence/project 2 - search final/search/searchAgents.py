        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[next_x][next_y]: 
                ...
                if (next_x, next_y) in self.corners:
                    ...
                    new_visited_corners[index] = True
...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    while unvisited:
        distances = [(manhattanDistance(current_position, corner), corner) for corner in unvisited]
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    max_distance = max(mazeDistance(position, food, problem.startingGameState) for food in food_positions)
    return max_distance
    return 0
