...
Open Cisco Packet Tracer (version 8.x or higher).

Go to File → Open and select the .pkt file.

Once loaded, you can view device configurations, run connectivity tests (ping, web access), and monitor routing tables.
